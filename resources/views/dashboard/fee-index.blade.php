...
<x-dashboard :title="$__title" :pageTitle="$__title">
    ...
    @if (isset($calculations['previous_months']) && isset($calculations['current']) && isset($calculations['calculations']))
        <table class="nk-tb-list is-separate nk-tb-ulist">
            @php 
                // dd($calculations);
                $previous_months = $calculations['previous_months'];
                $current = $calculations['current'];
                $calculations = $calculations['calculations'];
                $estimated = $calculations['estimated'] ?? false;
